...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_q999ke6','template_aya3cxe','#contact-form','kpVc-gd-Sko2m4J1o')
    .then(() =>{
        // Show sent message
...
$(document).ready(function(){
    ...
    const scrollActive = () =>{
      ...
      sections.each(function(){
        ...
        const sectionsClass = $('.nav__menu a[href*=' + sectionId + ']');
    ...
    // Add smooth scrolling for scroll-up icon
